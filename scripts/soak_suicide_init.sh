...
# SBI SRST_SHUTDOWN. OpenSBI's stub system_reset_device returns through
# to sbi_exit → sbi_platform_final_exit, the bhx-purgatory hook writes
# the PARKED magic, and the daemon's per-core watcher
# (scripts/soak_soft_reboot.sh) detects it and issues a release-from-
# purgatory. Cycle repeats.
#
